...
MY_USERNAME = "mariaa.losangel"
MY_PASSWORD = "Y1jh7g1r"
...
def send_pic(driver):
    ...
    try:
        for x in range(1, CHAT_SELECTIONS + 1):
            select_elem = driver.find_element(By.XPATH,
                                              f'//*[@id="root"]/div[1]/div[2]/div/div/div/div/div[1]/div/div/div/div/div[1]/form/div[3]/div/div[1]/div[{x}]/div[3]')
    ...
    print(
        f"EST. CUM. ACTUAL RATE: << {round((send_count - failed_batches * ERR_SEND_RATE_MULT) / (cur_time - START_TIME), 3)} snaps/second >>")
    print("=" * 80 + "\n")
    # displays data
